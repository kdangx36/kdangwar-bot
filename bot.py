...
# Hàm xử lý lấy tên khách hàng an toàn tuyệt đối (Fix lỗi mất tên)
def lay_ten_khach_hang(from_user):
...
# MENU CHÍNH DƯỚI THANH TIN NHẮN ĐƯỢC THIẾT KẾ ĐẸP MẮT
...
def send_welcome(message):
    ...
    ten_khach = lay_ten_khach_hang(message.from_user)
...
def callback_xu_ly(call):
    ...
    if call.data.startswith("amount_"):
        ...
        van_ban_nap = (
            ...
            f"3️⃣ Hệ thống sẽ tự điền Số tiền và Nội dung. Bạn chỉ cần bấm xác nhận chuyển khoản là xong!"
        )
